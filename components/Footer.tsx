	...
	return (
		<footer className='bg-[#1f2e40] text-white p-3 w-screen pb-7 mt-15 border-t-orange-800'>
			<div className="flex flex-col justify-center items-center gap-3 text-white">
				<Image src="https://cdn.prod.website-files.com/638b48215fd2fd34538fa6bc/6390122253829667e405c893_Funngrow%20Logo.svg" height={132} width={121} loading="lazy" alt="" className="flex justify-center items-center" />
				...
				<div className="flex items-center gap-5">
					...
					<div className="flex gap-2">
						<a href="https://play.google.com/store/apps/details?id=com.wishbanc.funngro" className="download-app-cta w-inline-block">
							<Image src="https://cdn.prod.website-files.com/638b48215fd2fd34538fa6bc/638c80744c238bae49b47ff4_image%2027.png" loading="lazy" alt="Get it on Google Play Banner" className="image-full-width" height={49} width={132}/>
						</a>
						<a href="https://apps.apple.com/in/app/funngro/id1579361075" className="download-app-cta w-inline-block">
							<Image src="https://cdn.prod.website-files.com/638b48215fd2fd34538fa6bc/638c80746a8a27189ca05fb9_image%2029.png" loading="lazy" alt="Download on the App Store Banner" className="image-full-width" height={49} width={132}/>
						</a>
					</div>
				</div>
				<div className="flex gap-5">
					...
					<a href="https://www.linkedin.com/company/funngro/" target="_blank" className="w-inline-block"><div className="footer-social-icon w-embed">
						<Image src='/linkedin.svg' height={24} width={24} alt='linkedin icon'/>
					</div>
					</a>
					<a href="https://wa.me/918828410412" target="_blank" className="w-inline-block">
						<div className="footer-social-icon w-embed">
							<Image src='/whatsapp.svg' height={24} width={24} alt='whatsapp icon'/>
						</div>
					</a>
